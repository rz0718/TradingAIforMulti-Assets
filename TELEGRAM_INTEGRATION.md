...
✨ **Professional formatting** with emojis and HTML styling
📊 **Real-time updates** sent at each trading iteration
🎯 **Clear structure** - Trades first, then positions, then summary
💰 **Detailed trade info** - Entry/exit prices, P&L, leverage, stop loss, take profit
📈 **Position tracking** - Unrealized P&L with percentage changes
🤖 **AI insights** - Short summaries generated by the portfolio manager
...
──────────────────────────────
🟢 BTC LONG (10x)
   💰 Entry: $43250.5000 → Current: $43350.0000
   📦 Quantity: 0.0500
   💚 Unrealized P&L: $5.00 (+2.31%)
   🎯 Target: $44500.0000 | 🛡️ Stop: $42800.0000

🔴 SOL SHORT (5x)
   💰 Entry: $98.5000 → Current: $97.8000
   💚 Unrealized P&L: $7.00 (+3.55%)
   🎯 Target: $95.0000 | 🛡️ Stop: $100.0000
...
💭 Bullish momentum building. Portfolio up this week. 🚀
...
Edit `bot/utils.py` → `format_trading_signal_message()` function to:
